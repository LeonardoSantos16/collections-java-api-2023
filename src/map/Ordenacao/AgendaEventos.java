...
public class AgendaEventos {
    ...
    public void exibirAgenda() {
        Map<LocalDate, Evento> eventosTreeMap = new TreeMap<>(eventosMap); // ordena os eventos em ordem crescente já que o localDate implementa o comparable
    ...
    Collection<Evento> values = eventosMap.values();*/
        ...
        for (Map.Entry<LocalDate, Evento> entry : eventosTreeMap.entrySet()) { //metodo entrySet retorna um set contando a ligação entre chave e valor
